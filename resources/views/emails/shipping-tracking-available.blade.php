    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="ag-mail-tableset" style="padding-bottom: 8px;">
                ...
                <p style="margin: 0; font-size: 15px; line-height: 1.8; color: #4b5563;">
                    Poštovani{{ $customerName ? ' ' . $customerName : '' }},<br>
        ...
        <tr>
            <td class="ag-mail-tableset" style="padding-top: 0;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: #f5f7f5; border: 1px solid #d8e0da; border-radius: 10px;">
                    <tr>
        ...
        <tr>
            <td class="ag-mail-tableset" style="padding-top: 0;">
                <p style="margin: 0; font-size: 14px; line-height: 1.8; color: #4b5563;">
                    Status se može promijeniti tek nakon što GLS obradi pošiljku. Ako poveznica ne prikaže novi status odmah, pokušajte ponovno malo kasnije.
                </p>
