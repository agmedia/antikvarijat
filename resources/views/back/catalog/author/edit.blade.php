...
@section('content')
    ...
    @include('back.catalog.partials.editor-hero', [
        'icon' => 'fa-user-pen',
        'title' => isset($author) ? 'Uredi autora' : 'Novi autor',
        'description' => isset($author) ? $author->title : 'Dodajte autora i pripadajuće bibliografske podatke.',
        'backUrl' => route('authors'),
    ])
        ...
        <form action="{{ isset($author) ? route('authors.update', ['author' => $author]) : route('authors.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h2 class="block-title"><i class="fa-duotone fa-user-pen mr-2"></i> Podaci autora</h2>
                ...
                <div class="block-content">
                    <div class="row justify-content-center push">
                        <div class="col-md-12">
                            ...
                            @include('back.layouts.partials.language-tabs', ['id' => 'author-content-tabs'])
                            <div class="tab-content">
                                <div class="tab-pane active" id="author-content-tabs-hr" role="tabpanel">
                                ...
                                <div class="tab-pane" id="author-content-tabs-en" role="tabpanel">
                                    <div class="form-group">
                                        <label for="title-en-input">Naziv EN</label>
                                        <input type="text" class="form-control" id="title-en-input" name="title_en" placeholder="Upišite engleski naziv autora" value="{{ old('title_en', isset($author) ? $author->title_en : '') }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="slug-en-input">SEO link EN</label>
                                        <input type="text" class="form-control" id="slug-en-input" name="slug_en" value="{{ old('slug_en', isset($author) ? $author->slug_en : '') }}" placeholder="Ako je prazno koristi se HR slug">
                                    </div>

                                    <div class="form-group">
                                        <label for="description-en-editor">Opis EN</label>
                                        <textarea id="description-en-editor" name="description_en">{!! old('description_en', isset($author) ? $author->description_en : '') !!}</textarea>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="row justify-content-center">
                        <div class="col-md-12 ">
                            @include('back.layouts.partials.language-tabs', ['id' => 'author-seo-tabs'])
                            <div class="tab-content">
                                <div class="tab-pane active" id="author-seo-tabs-hr" role="tabpanel">
                                    <div class="form-group">
                                ...
                                <div class="tab-pane" id="author-seo-tabs-en" role="tabpanel">
                                    <div class="form-group">
                                        <label for="meta-title-en-input">Meta naslov EN</label>
                                        <input type="text" class="js-maxlength form-control" id="meta-title-en-input" name="meta_title_en" value="{{ old('meta_title_en', isset($author) ? $author->meta_title_en : '') }}" maxlength="70" data-always-show="true" data-placement="top">
                                        <small class="form-text text-muted">
                                            70 znakova max
                                        </small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="js-maxlength form-control" id="meta-description-en-input" name="meta_description_en" rows="4" maxlength="160" data-always-show="true" data-placement="top">{{ old('meta_description_en', isset($author) ? $author->meta_description_en : '') }}</textarea>
                                        <small class="form-text text-muted">
                                            160 znakova max
                                        </small>
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mt-2">
                                        <img class="img-fluid" id="image-view" src="{{ \App\Support\AdminImage::url(isset($author) ? $author->image : null, 'media/img/lightslider.webp') }}" alt="">
                                    </div>
                ...
                <div class="admin-form-actions">
                        ...
                        @if (isset($author))
                                <a href="{{ route('authors.destroy', ['author' => $author]) }}" class="btn btn-outline-danger js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Obriši" onclick="event.preventDefault(); document.getElementById('delete-author-form{{ $author->id }}').submit();">
