                        ...
                        @forelse ($orders as $order)
                            ...
                            <tr>
                                ...
                                <td class="text-right" data-label="Radnje">
                                    ...
                                    @php($isBoxNowShipment = \Illuminate\Support\Str::contains($shipmentCarrierHint, ['boxnow', 'box now']))
                                    ...
                                    @elseif($isBoxNowShipment && $hasShipment)
                                        <button type="button" class="btn btn-light btn-sm disabled" disabled title="Box Now pošiljka je kreirana"><i class="fa-duotone fa-check text-success"></i></button>
                                        @if(filled($order->shipping_parcel_id) || filled($order->tracking_code))
                                            <a class="btn btn-alt-success btn-sm" href="{{ route('order.boxnow.label', ['order' => $order]) }}" title="Preuzmi Box Now PDF adresnicu" aria-label="Preuzmi Box Now PDF adresnicu za narudžbu {{ $order->id }}"><i class="fa-duotone fa-file-pdf"></i></a>
                                        @endif
                                    @elseif($hasShipment)
                                        <button type="button" class="btn btn-light btn-sm disabled" disabled title="Pošiljka je kreirana"><i class="fa-duotone fa-check text-success"></i></button>
                                    @elseif($isBoxNowShipment)
