<style>
    .withdrawal-page {
        --withdrawal-primary: #bfa76a;
        --withdrawal-primary-dark: #9f8545;
    ...
    .withdrawal-section__number {
        ...
        height: 1.85rem;
        border-radius: 999px;
        background: rgba(191, 167, 106, .15);
        color: var(--withdrawal-primary-dark);
        font-size: .8rem;
    }
    ...
    .withdrawal-page .form-control:focus {
        ...
        box-shadow: 0 0 0 .2rem rgba(191, 167, 106, .14);
    }
    ...
    .withdrawal-submit {
        ...
        font-size: .92rem;
        font-weight: 800;
        box-shadow: 0 .55rem 1.15rem rgba(159, 133, 69, .2);
    ...
    .withdrawal-submit:focus {
        ...
        color: #fff;
        box-shadow: 0 .7rem 1.35rem rgba(159, 133, 69, .26);
