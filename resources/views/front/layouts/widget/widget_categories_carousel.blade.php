...
<section class="border-top mb-0 pb-5 py-5" style="background-image: url({{ (isset($data['background']) && $data['background']) ? url('cache/image?src=media/img/glag.png') : '' }});-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
    <div class="container py-lg-3">
        ...
        <div class="tns-carousel pb-5">
            ...
            @foreach ($data['items'] as $item)
                <!-- Product-->
                    <div>
                        <div class="card"><a class="blog-entry-thumb" href="{{ route('catalog.route', ['group' => $item]) }}"><img class="card-img-top" load="lazy" src="{{ $item['image'] }}" width="400" height="230" alt="{{ $item['title'] }}"></a>
                            <div class="card-body">
