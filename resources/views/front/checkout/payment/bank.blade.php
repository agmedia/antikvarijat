<form id="payForm" name="pay" class="w-100 needs-validation" action="{{ route('checkout') }}" novalidate method="GET">
    ...
    <div class="form-check form-check-inline">
        ...
        <div class="invalid-feedback" >Morate se složiti sa Uvjetima kupnje.</div>
    </div>
    ...
    <div class="w-50 ps-2">
        <button id="paySubmit" class="btn btn-green d-block w-100" type="submit">
            <span class="d-none d-sm-inline">Završite narudžbu</span>
            <span class="d-inline d-sm-none">Završi kupnju</span>
