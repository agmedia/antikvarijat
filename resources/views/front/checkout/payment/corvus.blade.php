<form name="pay" class="w-100 needs-validation" action="{{ $data['action'] }}" novalidate method="POST">
    ...
    <div class="d-flex mt-3">
        ...
        <div class="w-50 ps-2"><button class="btn btn-green d-block w-100" type="submit"><span class="d-none d-sm-inline">Završite narudžbu</span><span class="d-inline d-sm-none">Završi kupnju</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></button></div>
    </div>
