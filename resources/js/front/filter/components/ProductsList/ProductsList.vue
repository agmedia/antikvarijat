        ...
        <div class="row mx-n2 mb-3" v-if="products.total">
            <div class="col-md-4 col-6 px-2 mb-4" v-for="product in products.data">
                <div class="card product-card-alt">
                    <span class="badge rounded-pill bg-primary mt-3 ms-1 badge-shadow" v-if="product.special">-{{ ($store.state.service.getDiscountAmount(product.price, product.special)).toFixed() }}%</span>
...
<!--                            <add-to-cart-btn-simple :id="(product.id).toString()"></add-to-cart-btn-simple>-->
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center price-box mt-2">
                            ...
                            <div class="bg-faded-accent text-accent fs-sm rounded-1 py-1 px-2" v-if="product.special">{{ $store.state.service.formatPrice(product.special) }}</div>
