...
class Helper
{
    ...
    public static function resolveYouTubeFrame(string $text): string
    {
        ...
        $text = str_replace('<figure class="media"></figure>', '<iframe width="560" height="315" src="' . $has[1][0] . '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>', $text);
