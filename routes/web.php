...
Route::middleware(['auth:sanctum', 'verified', 'no.customers'])->prefix('admin')->group(function () {
    ...
    Route::get('order/{order}/boxnow-label', [OrderController::class, 'boxnow_label'])->name('order.boxnow.label');
...
Route::prefix('api/v2')->group(function () {
    ...
    Route::post('products/update-item/single', [\App\Http\Controllers\Api\v2\ProductController::class, 'updateItem'])
        ->middleware(['auth:sanctum', 'verified', 'no.customers'])
        ->name('products.update.item');
