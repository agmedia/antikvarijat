...
class ContractWithdrawalTest extends TestCase
{
    ...
    protected function refreshInMemoryDatabase()
    {
        $this->artisan('migrate', [
            '--path' => [
                ...
                'database/migrations/2020_01_02_223800_create_bouncer_tables.php',
                'database/migrations/2020_01_02_223901_create_user_details_table.php',
                'database/migrations/2020_11_07_114044_create_orders_table.php',
                'database/migrations/2021_06_11_211244_create_settings_table.php',
                'database/migrations/2021_06_11_211245_create_pages_table.php',
    ...
    {
        $this->artisan('migrate', [
            '--path' => 'database/migrations/2026_07_29_120000_create_contract_withdrawals_table.php',
        ]);
    ...
    protected function setUp(): void
    {
        ...
        config([
            ...
            'mail.admin' => 'info@antikvarijat-biblos.hr',
        ]);
    ...
    public function test_withdrawal_is_reviewed_stored_with_evidence_and_emailed_to_both_parties(): void
    {
        ...
        app(ContractWithdrawalSettingsService::class)->save([
            ...
            'return_address' => 'BIBLOS TEST, Povratna 1, Zagreb',
        ...
        $this->assertSame('BIBLOS-1001', $withdrawal->order_number);
        ...
        Mail::assertSent(ContractWithdrawalAdminMail::class, function ($mail) use ($withdrawal) {
            return $mail->hasTo('raskidi@example.test')
                && $mail->withdrawal->is($withdrawal)
                && strpos($mail->build()->subject, 'BIBLOS-1001') !== false;
        });
    }
    ...
    private function makeWithdrawal(): ContractWithdrawal
    {
        $snapshot = [
            ...
            'declaration' => 'Ovime raskidam ugovor BIBLOS-1001.',
        ];
