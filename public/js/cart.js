...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("button", {
    staticClass: "btn btn-light btn-icon btn-shadow fs-base mx-2",
    attrs: {
      type: "button"
    },
    on: {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "text-accent fs-base ms-1"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatMainPrice(_vm.$store.state.cart.total)))]), _vm._v(" "), _vm.$store.state.cart.secondary_price ? _c("br") : _vm._e(), _vm._v(" "), _vm.$store.state.cart.secondary_price ? _c("span", {
    staticClass: "text-muted"
  }, [_vm._v("                ")]) : _vm._e(), _c("span", {
    staticClass: "text-accent fs-base ms-1"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatSecondaryPrice(_vm.$store.state.cart.total)))])]), _vm._v(" "), _c("a", {
    staticClass: "btn btn-outline-secondary btn-sm",
    attrs: {
      href: _vm.carturl
    }
  }, [_vm._v("Košarica"), _c("i", {
    staticClass: "ci-arrow-right ms-1 me-n1"
  })])]), _c("a", {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", [_vm._m(0), _vm._v(" "), !_vm.$store.state.cart.count ? _c("div", {
    staticClass: "d-flex pt-3 pb-2 mt-1"
  }, [_c("p", {
    staticClass: "text-dark mb-0"
  }, [_vm._v("Vaša košarica je prazna!")])]) : _vm._e(), _vm._v(" "), _vm.$store.state.cart.total < _vm.freeship && _vm.$store.state.cart.count ? _c("div", {
    staticClass: "d-flex border p-2",
    staticStyle: {
    ...
    staticClass: "small mb-0"
  }, [_vm._v("Ostvarili ste pravo na besplatnu dostavu!")])]) : _vm._e(), _vm._v(" "), _vm._l(_vm.$store.state.cart.items, function (item) {
    return _c("div", {
    ...
    staticClass: "d-flex pt-3 pb-4 pb-sm-5 mt-1"
  }, [_c("a", {
...
var render = function render() {
  ...
  return _c("div", [_vm.route == "kosarica" ? _c("div", {
    staticClass: "bg-white rounded-3 shadow-lg p-4"
  }, [_c("div", {
  ...
  }, [_vm._v("NASTAVI NA NAPLATU")]), _vm._v(" "), _c("p", {
    staticClass: "small fw-light text-center mt-2"
  }, [_vm._v("* Cijena dostave će biti izračunata na koraku 3: Dostava")])])]) : _vm._e(), _vm._v(" "), _vm.route == "naplata" ? _c("div", {
  ...
  }, [_vm._v("Sažetak narudžbe")]), _vm._v(" "), _c("hr", {
    staticClass: "mb-2"
  }), _vm._v(" "), _vm._l(_vm.$store.state.cart.items, function (item) {
    return _c("div", {
    ...
    staticClass: "fw-normal text-center my-2"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatMainPrice(_vm.$store.state.cart.total)))]), _vm._v(" "), _vm.$store.state.cart.secondary_price ? _c("h4", {
    staticClass: "fw-normal text-center my-2"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatSecondaryPrice(_vm.$store.state.cart.total)))]) : _vm._e(), _vm._v(" "), _c("p", {
    staticClass: "small fw-light text-center mt-4 mb-0"
  }, [_c("span", {
    staticClass: "fw-normal"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatMainPrice(_vm.$store.state.service.calculateItemsTax(_vm.$store.state.cart.items))))]), _vm._v(" PDV knjige i\n                "), _c("span", {
    staticClass: "fw-normal"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatMainPrice(_vm.$store.state.service.calculateItemsTax(_vm.$store.state.cart.total - _vm.$store.state.cart.subtotal))))]), _vm._v(" PDV dostava\n            ")]), _vm._v(" "), _vm.$store.state.cart.secondary_price ? _c("p", {
    staticClass: "small fw-light text-center mt-2 mb-0"
  }, [_c("span", {
    staticClass: "fw-normal"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatSecondaryPrice(_vm.$store.state.service.calculateItemsTax(_vm.$store.state.cart.items))))]), _vm._v(" PDV knjige i\n                "), _c("span", {
    staticClass: "fw-normal"
  }, [_vm._v(_vm._s(_vm.$store.state.service.formatSecondaryPrice(_vm.$store.state.service.calculateItemsTax(_vm.$store.state.cart.total - _vm.$store.state.cart.subtotal))))]), _vm._v(" PDV dostava\n            ")]) : _vm._e(), _vm._v(" "), _c("p", {
    staticClass: "small text-center mt-0 mb-0"
  }, [_vm._v("*Uračunato u cijenu")])])]) : _vm._e(), _vm._v(" "), _vm.route == "pregled" ? _c("div", {
    staticClass: "bg-white rounded-3 shadow-lg p-4 ms-lg-auto"
  }, [_c("div", {
    staticClass: "py-2 px-xl-2"
    ...
    staticClass: "small text-center mt-0 mb-0"
  }, [_vm._v("*Uračunato u cijenu")])])]) : _vm._e()]);
};
var staticRenderFns = [function () {
  var _vm = this,
    _c = _vm._self._c;
...
var render = function render() {
  ...
  return _c("aside", {
    ...
    }, [_vm._v("\n                                " + _vm._s(category.title) + " "), _c("span", {
      staticClass: "badge bg-secondary ms-2 position-absolute end-0"
    }, [_vm._v(_vm._s(Number(category.count).toLocaleString("hr-HR")))])])]);
...
var render = function render() {
  ...
  return _c("section", {
    ...
    return _c("div", {
      staticClass: "col-md-4 col-6 px-2 mb-4"
    }, [_c("div", {
      staticClass: "card product-card-alt"
      ...
      staticClass: "bg-faded-accent text-accent fs-sm rounded-1 py-1 px-2"
    }, [_vm._v(_vm._s(product.secondary_price_text))]) : _vm._e()]) : _vm._e()])]), _vm._v(" "), _c("hr", {
